...
WritCreater.strings["alchemyCraftReqs"] = "Fabriquer va utiliser <<t:4>> <<t:1>>, <<t:4>> <<t:2>>, et <<t:4>> <<t:3>> == For example, Crafting will use 1 columbine, 1 blugloss, and 1 imp stool =="
...
WritCreater.strings["masterRecipeCraft"] = "<<t:1>>: Fabrique <<t:3>>x<<t:2>> == t:3 is the amount to make of the item, t:2 is the item link =="
