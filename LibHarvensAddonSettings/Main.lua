if LibHarvensAddonSettings then
    local msg = "Please remove LibHarvensAddonSettings as this may cause issues in the future (like this one)"
    error(msg)
end

LibHarvensAddonSettings = {}
LibHarvensAddonSettings.version = 20003
...
--
--    self.hasShownIntro = false
--    if self.hasShownIntro then return end
--    self.hasShownIntro = true
--
--    local msg = "LibVotans has been brought back to console by Scribe Rob, available on Xbox EU or on Discord (robjonesweb). Thank you for Votan for giving permission so that other great addons can return to console. LibVotans enables the return of console addons such as Votans Minimap and gamer_sa22 Fishing Maps. Any issues can go through these channels. Please remove LibHarvensAddonSettings as this may cause issues in the future"
